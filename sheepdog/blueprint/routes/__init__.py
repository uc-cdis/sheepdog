...
routes = [
    ...
    new_route("/<program>", views.program.get_projects, methods=["GET"]),
    new_route(
        "/<program>", views.program.create_project, methods=["PUT", "POST", "PATCH"]
    ),
    new_route("/<program>", views.program.delete_program, methods=["DELETE"]),
    new_route(
        "/<program>/<project>", views.program.project.delete_project, methods=["DELETE"]
    ),
    new_route(
        "/<program>/<project>",
    ...
    new_route(
        ...
        methods=["PUT"],
        swagger={"summary": "Update entities"},
    ),
    new_route(
    ...
    new_route(
        ...
        methods=["PUT"],
        swagger={"summary": "Update entities", "tags": ["dry run"]},
    ),
    new_route(
    ...
    new_route(
        ...
        methods=["PUT"],
        swagger={"summary": "Update entities in bulk"},
    ),
    new_route(
    ...
    new_route(
        ...
        methods=["PUT"],
        swagger={"summary": "Update entities in bulk", "tags": ["dry run"]},
    ),
    new_route(
    ...
    new_route("/template", views.get_templates, methods=["GET"]),
    new_route("/template/<entity>", views.get_template, methods=["GET"]),
    new_route(
        "/validation/upload_manifest", views.validate_upload_manifest, methods=["POST"]
    ),
    new_route(
