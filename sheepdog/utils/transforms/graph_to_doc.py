...
def is_property_hidden(key, schema, exclude_id):
    ...
    systemProperties are properties used for bookkeeping but aren't user facing.
    ...
    # If it's a system property then hide it.
    if is_system_prop:
        return True
    ...
    # If not a system property then don't hide.
    return False
